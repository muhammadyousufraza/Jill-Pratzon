...
Gallery with thumbnail slider(GWTS) is a very nifty responsive gallery plugin that helps you put images and slideshows wherever you need. You can add GWTS in your Wordpress posts, pages, or custom post types via shortcodes or simply enabling ‘page’ or ‘post’ through GWTS settings.
...
3. Goto the admin GWL Gallery Menu and it's submenu to set up options
...
Go to the admin menu and select the "settings" under the "GWL Gallery" Menu, try to do different options and check slider to changes.

= How to enable slider on post, pages or custom post types? =

Go to the admin menu > GWL Gallery and choose post type where you want to display the slider.
